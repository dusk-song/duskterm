...
impl Sender {
    ...
    pub fn new() -> Result<Self, Error> {
        let mut sender = Self {
            ...
            file_size: 0,
            file_modified_unix_seconds: None,
            has_file: false,
    ...
    pub fn start_file(&mut self, info: FileInfo) -> Result<(), Error> {
        ...
        let file_modified_unix_seconds = info.modified_unix_seconds;
        if !matches!(
            self.state,
        ...
        self.file_modified_unix_seconds = file_modified_unix_seconds;
        self.has_file = true;
    ...
    fn queue_zfile(&mut self) -> Result<(), Error> {
        ...
        let file_modified_unix_seconds = self.file_modified_unix_seconds;
