...
pub struct FileInfo<'a> {
    ...
    /// Last modification time as Unix seconds when known.
...
impl<'a> FileInfo<'a> {
    ...
    /// Adds the last modification time advertised in the ZFILE metadata.
    #[must_use]
    pub const fn with_modified_unix_seconds(mut self, seconds: u64) -> Self {
...
pub enum Event<'a> {
    ...
    FileCompleted,
    /// The receiver explicitly skipped the current file.
    FileSkipped,
